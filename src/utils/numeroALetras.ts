...
export function NumeroALetras(num: number, pesosAlFinal: boolean) {
    let data = {
        numero: num,
        enteros: Math.floor(num),
        centavos: (((Math.round(num * 100)) - (Math.floor(num) * 100))),
        letrasCentavos: '',
        letrasMonedaPlural: pesosAlFinal ? 'PESOS' : '',//'PESOS', 'Dólares', 'Bolívares', 'etcs'
        letrasMonedaSingular: pesosAlFinal ? 'PESO' : '', //'PESO', 'Dólar', 'Bolivar', 'etc'
