...
export const ContextoProvider = ({ children }: Props) => {
    ...
    return <MiContexto.Provider value={{ productosSeleccionados, setProductosSeleccionados, cliente, setCliente, totales, setTotales, descuento, setDescuento, lista, setLista }}>
        {children}
    </MiContexto.Provider>
}
